...
class FileLoader(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        feed_dict = {"img": img.transpose(2,0,1)/255}
        feed_dict["mask"] = ann[..., 1] > 0  # HW1 -> HW
        # if self.with_type:
        #     type_map = (ann[..., 1]).copy()
...
if __name__=="__main__":
    import glob, os
    file_list = glob.glob("../../hover_net/dataset/training_data/consep/consep/train/540x540_164x164/*.npy")

    dset = FileLoader(file_list,
                      input_shape=(270, 270),
                      mask_shape=(270, 270),
                      mode="train",
                      )
